                        ...
                        <tbody>
                          ...
                          if (isset($kwitansi)) {
                            foreach ($kwitansi->result() as $row) {
                              ...
                              <a href="#" class="btn btn-success btn-sm" data-tooltip="tooltip" title="Edit" id="ubahPj" data-id="<?= $row->idKwitansi ?>" data-nosur="<?= $row->noSuratTugas ?>" data-tglkw="<?= $row->tglKwitansi ?>" data-toggle="modal" data-target="#editPJ">
