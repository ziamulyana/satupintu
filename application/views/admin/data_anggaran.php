											...
											<tbody>
												...
												if (isset($anggaran)) {
													foreach ($anggaran as $row) {
														...
														<a href="#" class="btn btn-success btn-sm" data-tooltip="tooltip" title="Edit" id="editA" data-idag="<?= $row->idAnggaran ?>" data-makag="<?= $row->mak ?>" data-namag="<?= $row->namaAnggaran ?>" data-ukag="<?= $row->uraianKegiatan ?>" data-diviag="<?= $row->divisi ?>" data-kodeag="<?= $row->kode ?>" data-paguag="<?= $row->pagu ?>" data-toggle="modal" data-target="#editAnggaran"><i class="fa fa-edit"></i></a>
