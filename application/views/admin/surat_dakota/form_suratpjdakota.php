                ...
                <div class="row">
                  <div class="col-xs-12">
                   ...
                   <table class="table table-bordered table-hover" id="dynamic_field">
                    <tr>
                      <td><input type="text" name="uraian[]" placeholder="Uraian Biaya" class="form-control name_list" /></td>
                      <td><select name="sub_category_item" id="kategori[]" class="form-control input-sm" data-live-search="true" title="Kategori">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#add").click(function(){
      i++;
      $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="uraian[]" placeholder="Uraian Biaya" class="form-control name_list"/></td>  <td><select name="kategori[]"  class="form-control input-sm" data-live-search="true" title="Select Sub Category">  <option>Pilih Kategori</option>  <option>UH</option> <option>TR</option><option>RL</option><option>HT</option></select></td><td><input type="text" name="jumlah[]" placeholder="Jumlah Biaya" class="form-control name_email"/></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
    });
