                ...
                <tbody>
                  ...
                  if (isset($capa)) {
                    foreach ($capa->result() as $row) {
                      ...
                      <a href="<?= site_url('admin/surat_capa/editCapa/' . $row->idPeringatan) ?>" class="btn btn-success btn-sm" data-tooltip="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                      ...
                      <a href="#" class="btn btn-info btn-sm" data-tooltip="tooltip" title="Print" id="printSur" data-toggle="modal" data-target="#printCapa" data-id="<?= $row->idPeringatan ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body" id=panelSur>
              <form role="form" method="post" action="<?= base_url('admin/surat_capa/printCapa') ?>">
                <div class="box-body">
