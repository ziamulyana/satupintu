...
<head>
	...
	<!-- CSS buatan sendiri -->
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/vendor/bootstrap/css/peringatan.css">
</head>
	...
	<div class="page">
		...
		<div class="Section1">
			...
			<table style="width:100%">
				...
				<tr>
					<td>
						<p style="font-family:arial;"><b><?php echo $penerimaSurat; ?></b></p>
					</td>
				</tr>
				<tr>
					<td>
						<p style="font-family:arial;"><b>di</b></p>
					</td>
				</tr>
				<tr>
					<td>
						<p style="font-family:arial;" id="space1"><b><?php echo " " . $kotaSurat ?></b></p>
					</td>
				</tr>
			</table>
			<!-- paragraf 1 -->
			<br>
			<p style="font-family:arial;" class="paragraf">Berdasarkan hasil pemeriksaan petugas Balai POM di Batam pada tanggal <?php echo convertDay($tglMulaiperiksa) . " " . convertMonthB(convertMonthA($tglMulaiperiksa)) . " " . convertYear($tglMulaiperiksa) ?>
			...
			<table style="width:100%">
				...
				<tr>
					<td>
						<p style="font-family:arial;" id="space2">Nomor SIPTTK</p>
					</td>
					<td>
			...
			<p style="font-family:arial;" class="paragraf">Sehubungan dengan temuan tersebut di atas, kami memberikan sanksi
				<b>PERINGATAN</b> dan kepada Saudara agar:
			</p>
			<p style="font-family:arial;" id="space1">
			<ol>
				<li>
					<p style="font-family:arial;" class="paragraf">Melakukan tindak lanjut terhadap temuan dengan membuat <i>Correstyle="font-family:arial;"ctive Action</i> dan <i>Preventive Action</i> (CAPA)</p>
				</li>
				<li>
					<p style="font-family:arial;" class="paragraf">Melaporkan hasil tindak lanjut dan CAPA tersebut paling lambat 21 (dua puluh satu) hari kerja sejak dilakukan pemeriksaan sarana dengan disertai data/dokumen pendukung Dinas Kesehatan Kota Batam
					</p>
				</li>
				<li>
					<p style="font-family:arial;" class="paragraf">Apabila CAPA tidak dilaporkan sesuai ketentuan dapat dstyle="font-family:arial;"ikenakan sanksi bertingkat sesuai prosedur yang berlaku.</p>
				</li>
				<li>
			...
			<table style="width:100%">
				<tr>
					<th class="c">
						<p style="font-family:arial;" class="satu" id="hilang">Cobacabicobacabicobacabicobacabi</p>
					</th>
					<th class="c">
						<p style="font-family:arial;" class="satu"><b>Kepala Balai Pengawas Obat dan Makanan</b></p>
					</th>
				</tr>
				<tr>
					<td>
						<p style="font-family:arial;" id="hilang">Cobacabicobacabicobacabicobacabi</p>
					</td>
					<td>
						<p style="font-family:arial;"><b>Di Batam</b></p>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<p style="font-family:arial;"><b>Bagus Heri Purnomo, S.Si., Apt.</b></p>
					</td>
				</tr>
