  <section class="content-header">
    <h1>
      Edit Surat Tindak Lanjut Untuk Pangan
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Tindak Lanjut</a></li>
      <li><a href="#">Surat Pangan</a></li>
      <li><a href="#">Edit Pangan</a></li>
    </ol>
  </section>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <form role="form" action="<?php echo base_url('petugas/surat_peringatan/surat_pangan/editPeringatan') ?>" method="post">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="col-md-6">
                ...
                <!-- nama pj-->
                <div class="form-group row">
                  <label for="noSurat" class="col-sm-6 col-form-label">Nama Pemilik<span class="wajib"> *</span></label>
                  <div class="col-sm-12">
                    <div class="input-group">
