  <section class="content-header">
    <h1>
      Buat Surat Tindak Lanjut Untuk Pangan
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <form role="form" action="<?php echo base_url('petugas/surat_peringatan/surat_pangan/simpanPeringatan') ?>" method="post">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="col-md-6">
                ...
                <!-- nama pemilik-->
                <div class="form-group row">
                  <label for="noSurat" class="col-sm-5 col-form-label">Nama Pemilik<span class="wajib"> *</span></label>
                  <div class="col-sm-12">
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-building"></i></span>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-12">
                  <select class="category related-post form-control" name="pilihPasal[]" id="pilihPasal" multiple="multiple" data-placeholder="Pilih Pasal" style="width: 100%;" required>
                    <?php
                    foreach ($temuan_pangan as $temuan) {
              ...
              <div class="box-footer">
                <button type="submit" value="submit" onclick="return chk_date()" class="btn btn-info"><i class="fa fa-save"></i> Save Document</button>
