		...
		<div class="Section1">
			...
			<table style="width:100%">
				<tr>
					...
					<p style="font-family:arial;">&nbsp;</p></th>
				</tr>
				<tr>
					<td>
			...
			<!-- paragraf 1 -->
			<br>
			<p style="font-family:arial;" class="paragraf">Berdasarkan hasil pemeriksaan petugas Balai POM di Batam pada tanggal <?php echo convertDay($tglMulaiperiksa) . " " . convertMonthB(convertMonthA($tglMulaiperiksa)) . " " . convertYear($tglMulaiperiksa) ?>, terhadap sarana: </p>
			<!-- paragraf 2 -->
			<table style="width:100%">
				<tr>
					<th class="a">
