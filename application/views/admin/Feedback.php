<section class="content-header">
  <h1>
    <div class="icon">
      <i class="glyphicon glyphicon-list-alt text-red"></i> Laporan Feedback CAPA
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <!-- /.box-header -->
              <td>
              <a href="<?php echo base_url('admin/entry_capa_c')?>" class="btn btn-block btn-social btn-success">
                <i class="fa fa-pencil"></i> Entry Feedback CAPA
              </a>
              </td>
              <div class="box-body">
