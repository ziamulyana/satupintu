<section class="content-header">
  <h1>
    Buat Surat Tugas Substansi Penindakan
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
  <div class="row">
   <div class="col-md-12">
     <form role="form" action="<?php echo base_url('admin/surat_tugas/surattugas_penindakan/simpan_surat')?>" method="post">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-12">
              <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="T-PW.01.12.9A3." name="noSuratTugas" id="noSuratTugas" required>
              </div>
            </div>
          </div>
