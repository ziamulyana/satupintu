<section class="content-header">
 <h1>
   Surat Tugas Substansi Pemeriksaan
 </h1>
 <ol class="breadcrumb">
  <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
  <li><a href="#">Surat Tugas Substansi Pemeriksaan</a></li>
</ol>
</section>
<!-- Main content -->
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        ...
        <div class="pull-right">
          <ul>
            <a class= "btn btn-primary" href="<?php echo base_url('admin/surat_tugas/surattugas_pem/tambah_surat')?>">
