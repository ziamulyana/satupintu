 ...
 <h1>
   Surat Pertanggung Jawaban Luar Kota
 </h1>
 <ol class="breadcrumb">
  ...
  <div class="row">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Daftar Surat Pertanggung Jawaban Luar Kota</h3>
          <div class="pull-right">
            <ul>
              <a class= "btn btn-primary" href="<?php echo base_url('admin/surat_tugaslukota/form_suratpj')?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="icon fa fa-edit"></i>  Form Edit Data Surat Pertanggung Jawaban Luar Kota</h4>
                </div>
