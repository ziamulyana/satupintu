<section class="content-header">
  <h1>
    Buat Surat Pertanggung Jawaban Luar Kota
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">Dashboard</a></li>
    <li><a href="#">Surat Pertanggung Jawaban Luar Kota</a></li>
  </ol>
</section>
     ...
     <form role="form" action="<?php echo base_url('petugas/surat_peringatan/surat_obat/surat')?>" method="post">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form Pembuatan Surat Pertangung Jawaban Luar Kota</h3>
        ...
        <div class="col-md-6">
          ...
          <!-- jumlah biaya -->
          <div class="form-group row">
            <label for="nip" class="col-sm-4 col-form-label">Jumlah Biaya<span class="wajib"> *</span></label>
            <div class="col-sm-12">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-building"></i></span>
                <input type="text" class="form-control" name="nip" id="nip" placeholder="Jumlah biaya" required>
              </div>
            </div>
          </div>
          ...
          <!-- Nominal terbilang -->
          <div class="form-group row">
            <label for="pejabatPembuatkomitmen" class="col-sm-6 col-form-label">Terbilang<span class="wajib"> *</span></label>
            <div class="col-sm-12">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" class="form-control" name="lamaTugas" id="lamaTugas" placeholder="Terbilang" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-12"> 
              <input class="form-control" type="date" name ="tanggalSurat" id="tanggalKwitansi" placeholder="Tanggal" required>
            </div>
          </div>

          <!-- Nomor SPPD -->
          <div class="form-group row">
            <label for="lamaTugas" class="col-sm-6 col-form-label">Nomor SPPD<span class="wajib"> *</span></label>
            <div class="col-sm-12">
              <div class="input-group">
