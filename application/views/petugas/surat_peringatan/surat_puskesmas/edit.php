  <section class="content-header">
    <h1>
      Edit Surat Tindak Lanjut Untuk Puskesmas
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Tindak Lanjut</a></li>
      <li><a href="#">Surat Puskesmas</a></li>
      <li><a href="#">Edit Puskesmas</a></li>
    </ol>
  </section>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <form role="form" action="<?php echo base_url('petugas/surat_peringatan/surat_puskesmas/editPeringatan') ?>" method="post">
