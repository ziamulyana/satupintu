	...
	<div class="page">
			...
			<table style="width:100%">
				<tr>
					...
					<th class="dua"><p style="font-family:arial;">Batam, <?phpstyle="font-family:arial;" echo convertDay($tanggal)." ".convertMonthB(convertMonthA($tanggal))." ".convertYear($tanggal) ?></p></th> 
