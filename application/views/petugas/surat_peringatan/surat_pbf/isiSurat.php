...
<body style="font-family:arial;" onload="window.print()">
	...
	<table style="width:100%">
		...
		<tr>
			<td><p style="font-family:arial;" id="space2">Nama Pimpinan</p></td>
			<td><p style="font-family:arial;">: <?php echo $namaPimpinan; ?></p></td>
		</tr>
		...
		<tr>
			<td><p style="font-family:arial;" id="space2">Nomor SIPA</p></td>
