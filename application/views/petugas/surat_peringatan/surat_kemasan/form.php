  <section class="content-header">
    <h1>
      Buat Surat Peringatan Untuk Kemasan
    </h1>
    <ol class="breadcrumb">
...
<!-- nomor surat tugas -->
          ...
          <div class="col-md-6">
            ...
            <!-- alamat pengolahan -->
            <div class="form-group row">
              <label for="noSurat" class="col-sm-4 col-form-label">Alamat Unit Pengolahan<span class="wajib"> *</span></label>
              <div class="col-sm-12">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-building"></i></span>
          ...
          <div class="col-md-12">
            ...
            <div class="form-group row">
             <label for="detailTemuan" class="col-sm-3 col-form-label">Nomor Izin Edar<span class="wajib"> *</span></label>
             <div class="col-md-12">
              <!-- /.card-header -->
