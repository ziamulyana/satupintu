...
<body onload="window.print()">
	...
	<table style="width:100%">
		<tr>
			<th class="a"><p class="satu" id="space2">Nama Sarana</p></th>
			<th class="b"><p class="satu">: <?php echo $namaSarana; ?></p></th>
		</tr>

		<tr>
			<td><p id="space2">Alamat Sarana</p></td>
			<td><p>: <?php echo $alamatSarana; ?></p></td>
		</tr>

		<tr>
			<td><p id="space2">NIB</p></td>
			<td><p>: <?php echo $nib; ?></p></td>
		</tr>

		<tr>
			<td><p id="space2">No. Telp</p></td>
	...
	<table style="width:100%">
		<tr>
			<th class="a"><p class="satu" id="space2">Nomor Izin Edar</p></th>
			<th class="b"><p class="satu">:</p></th>
		</tr>
	</table>
	<p><?php echo $noIzin; ?></p>
	...
	<table style="width:100%">
		<tr>
			<th class="a"><p class="satu" id="space2">Nama Pimpinan</p></th>
			<th class="b"><p class="satu">: <?php echo $namaPimpinan; ?></p></th>
		</tr>
		<tr>
			<td><p id="space2">Penanggung Jawab Produksi</p></td>
