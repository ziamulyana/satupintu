...
<body style="font-family:arial;" onload="window.print()">
	...
	<div class="page">
		...
		<p style="font-family:arial;" class="paragraf"><?php echo "<p class='paragrastyle='font-family:arial;'f'>" . $detailTemuan . "</p>" ?></p>
		<!-- paragraf 4 -->
		...
		<ol>
			<li>
				<p style="font-family:arial;" class="paragraf">Melakukan tindak lanjut terhadap temuan dengan membuatstyle="font-family:arial;" <i>Corrective Action</i> dan <i>Preventive Action</i> (CAPA)</p>
			</li>
			<li>
