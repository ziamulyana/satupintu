...
<body onload="window.print()">
	...
	<div class="page">
		...
		<table style="width:100%">
			<tr>
				<th class="a"><p style="font-style="font-family:arial;"family:arial;"class="satu" id="space2">Nama</p></th>
		...
		<p style="font-family:arial;"class="paragraf">Sehubungan dengan temuan tersebut di atas, kami memberikan sanksi 
			...
			<p style="font-family:arial;"id="space1"><ol>
				<li><p style="font-family:arial;"class="paragraf">Melakukan tindak lanjut terhadap temuan dengan membuatstyle="font-family:arial;" <i>Corrective Action</i> dan <i>Preventive Action</i> (CAPA)</p></li>
