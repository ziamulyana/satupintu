            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right">
                        <ul>
                            <a class="btn btn-primary" href="<?php echo base_url('petugas/master/tambah_sarana') ?>">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($sarana)) {
                                                    foreach ($sarana as $row) {
                                                        ...
                                                        <a href="#" class="btn btn-success btn-sm" data-tooltip="tooltip" title="Edit" id="editSar" data-id="<?= $row->idSarana ?>" data-namas="<?= $row->namaSarana ?>" data-alamats="<?= $row->alamatSarana ?>" data-jeniss="<?= $row->jenisSarana ?>" data-produks="<?= $row->produkSarana ?>" data-kotas="<?= $row->kotaSarana ?>" data-kecamatans="<?= $row->kecamatanSarana ?>" data-kelurahans="<?= $row->kelurahanSarana ?>" data-kategoris="<?= $row->kategoriSarana ?>" data-toggle="modal" data-target="#editSarana"><i class="fa fa-edit"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id=editData>
                    <form action="<?= base_url('petugas/Master/ubahSarana') ?>" method="post">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="hapusData">
                    <form role="form" method="post" action="<?= base_url('petugas/Master/hapus_dataSarana') ?>">
                        <div class="box-body">
