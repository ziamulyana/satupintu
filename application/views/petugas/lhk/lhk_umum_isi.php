...
<body style="font-family:arial;" onload="window.print()">
	...
	<div class="page2">
		...
		<table style="width:100%">
			...
			<tr>
				<td><p><b>II.</b></p></td> 
				<td><p class="satu"><b>TUJUAN PEMERIKSAAN :</b> 
					
					</td> 
			</tr>
			<tr>
				<td><p id="hilang">I</p></td> 
				<td><p class="satu"><?php echo $maksud?></p></td> 
			</tr>

			<tr>
				<td><p><b>III.</b></p></td> 
				<td><p class="satu"><b>DAERAH YANG DIKUNJUNGI :</b> 
					
					</td> 
			</tr>
			<tr>
				<td><p id="hilang">I</p></td> 
				<td><p class="satu"><?php echo $kota?></p></td> 
			</tr>

			<td><p><b>IV.</b></p></td> 
				<td><p class="satu"><b>YANG MELAKSANAKAN PEMERIKSAAN :</b> 
		...
		<table style="width:100%">
			...
			<tr>
				<td><p><b>VI.</b></p></td>
				<td><p class="satu"><b>KETERANGAN</b></p></td>
				<td><p class="satu">&nbsp;</p></td> 
				<td><p class="satu">&nbsp;</p></td> 
			</tr>
			<tr>
