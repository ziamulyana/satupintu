...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <form action="<?php echo site_url('petugas/lhk/lhk_sampling_c/edit') ?>" method="post"  role="form">
                       ...
                       <div class="col-md-12">
                        ...
                        <div class="box-body pad">
                          <div class="">
                            ...
                            style="width: 100%; height: 200px; font-size: 12px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required ><?php echo $rincianSampling ?></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
