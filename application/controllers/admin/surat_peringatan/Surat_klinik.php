	...
	class Surat_klinik extends CI_Controller
	{
		...
		public function index()
		{
			...
			$this->template->load('layouts/admin_template', 'admin/surat_peringatan/surat_klinik/form', $data);
		}
		...
		public function simpanPeringatan()
		{
			...
			if ($checkvalidation == true) {
				...
				redirect('admin/surat_peringatan/Surat_klinik', 'refresh');
			}
		}
		...
		public function surat()
		{
			...
			$this->load->view('admin/surat_peringatan/surat_klinik/isiSurat', $data, FALSE);
		}
	}
