	...
	class Surat_obat extends CI_Controller
	{
		...
		public function index()
		{
			...
			$this->template->load('layouts/admin_template', 'admin/surat_peringatan/surat_obat/form', $data);
		}
		...
		public function simpanPeringatan()
		{
			...
			if ($checkvalidation == true) {
				...
				redirect('admin/surat_peringatan/Surat_obat', 'refresh');
			}
		}
		...
		public function surat()
		{
			...
			$this->load->view('admin/surat_peringatan/surat_obat/isiSurat', $data, FALSE);
		}
	}
