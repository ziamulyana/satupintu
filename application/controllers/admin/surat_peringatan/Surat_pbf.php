		...
		class Surat_pbf extends CI_Controller
		{
			...
			public function index()
			{
				...
				$this->template->load('layouts/admin_template', 'admin/surat_peringatan/surat_pbf/form', $data);
			}
			...
			public function simpanPeringatan()
			{
				...
				if ($checkvalidation == true) {
					...
					redirect('admin/surat_peringatan/Surat_pbf', 'refresh');
				}
			}
			...
			public function surat()
			{
				...
				$this->load->view('admin/surat_peringatan/surat_pbf/isiSurat', $data, FALSE);
			}
		}
