<?php
	...
	class Form_suratPJdakota extends CI_Controller {
	// main page
		...
		public function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('SuratPJdakota_model');
    }
		...
		public function index()
		{
        	...
        	$this->template->load('layouts/admin_template', 'admin/surat_dakota/form_suratpjdakota.php', $data);
