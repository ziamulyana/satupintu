...
class Surat_capa extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->template->load('layouts/admin_template', 'admin/surat_peringatan/capa/list_capa', $data);
	}
	...
	public function buatCapa()
	{
		...
		$this->template->load('layouts/admin_template', 'admin/surat_peringatan/capa/sub_capa', $data);
	}
	...
	public function simpanCapa()
	{
		...
		if ($checkvalidation == true) {
			...
			redirect('admin/surat_capa', 'refresh');
		} else {
			// $this->session->set_flashdata('failed', 'Maaf, Data tidak diprses karena duplikat');
			redirect('admin/surat_capa/buat_capa', 'refresh');
		}
	}
	...
	public function editCapa()
	{
		...
		$this->template->load('layouts/admin_template', 'admin/surat_peringatan/capa/edit_capa', $data);
	}
	...
	public function printCapa()
	{
		...
		$this->load->view('admin/surat_peringatan/capa/surat_capa', $data, FALSE);
	}
