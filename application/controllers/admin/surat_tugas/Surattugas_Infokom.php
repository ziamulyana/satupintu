...
class Surattugas_Infokom extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->template->load('layouts/admin_template', 'admin/surat_tugas/surattugas_infokom', $data);  
    ...
    public function simpan_surat()
    {
        ...
        $noSuratFix = "T-PW.01.12.9A4.".convertMonths($tanggalolah).".".convertYears($tanggalolah).".".$nosurat;
