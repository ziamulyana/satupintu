<?php
	...
	class Form_suratPJ extends CI_Controller {
	// main page
		...
		public function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('SuratPJlukota_model');
    }


		public function index()
		{
			$data = konfigurasi('Form Surat Pertanggung Jawaban',"ap");
			$data['surat_tugas'] = $this->SuratTl_model->getSuratTugas();
        	$this->template->load('layouts/admin_template', 'admin/surat_lukota/form_suratpj', $data);
